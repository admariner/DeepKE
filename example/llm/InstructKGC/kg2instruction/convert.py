    ...
    with open(src_path, "r", encoding="utf-8") as reader:
        for line in reader:
            ...
            if task == 'EE':
                ...
                new_rels, rels_type = rel_sort(record['text'], record['relation'])
                ...
                new_ents, ents_type = ent_sort(record['text'], record['entity'])
...
if __name__ == "__main__":
    ...
    parse.add_argument("--sample", type=int, default=0, help="若为-1, 则从4种指令和4种输出格式种随机采样其中一种, 否则即为指定的指令格式, -1<=sample<=3")
